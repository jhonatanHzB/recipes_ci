    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="<?= base_url() ?>admin/dashboard" class="side-menu__item active">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="<?= base_url() ?>admin/dashboard/create" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"
                             fill="currentColor">
                            <path
                    ...
                    <a href="<?= base_url() ?>admin/dashboard/edit-recipes" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"
                             fill="currentColor">
                            <path
                ...
                <li class="slide">
                    <a href="icons.html" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Temporada</span>
                    </a>
                    <a href="icons.html" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"
                             fill="currentColor">
                        ...
                        <span class="side-menu__label">Día Festivo</span>
                    </a>
                    <a href="icons.html" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"
                             fill="currentColor">
                        ...
                        <span class="side-menu__label"><?= $sections[0] ?></span>
                    </a>
                    <a href="icons.html" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"
                             fill="currentColor">
                        ...
                        <span class="side-menu__label"><?= $sections[1] ?></span>
                    </a>
                    <a href="icons.html" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"
                             fill="currentColor">
                        ...
                        <span class="side-menu__label"><?= $sections[2] ?></span>
                    </a>
                </li>
                <!-- End::slide -->
