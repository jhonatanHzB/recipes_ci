...
<div class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title text-default" id="offcanvasRightLabel">Conmutador</h5>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                ...
                <div class="navigation-menu-styles">
                    <p class="switcher-style-head">Estilos de menú verticales y horizontales:</p>
            ...
            <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel"
                ...
                <div>
                    <div class="theme-colors">
                        ...
                        <div class="px-4 pb-3 text-muted fs-11">Nota: Si desea cambiar el color del menú de forma dinámica, cambie desde el selector de color principal del tema que se encuentra debajo</div>
                    </div>
                    <div class="theme-colors">
                        ...
                        <div class="px-4 pb-3 text-muted fs-11">Nota: Si desea cambiar el color del encabezado de forma dinámica, cambie desde el selector de color principal del tema que se encuentra debajo</div>
                    </div>
                    <div class="theme-colors">
                    ...
                    <div class="theme-colors">
                        <p class="switcher-style-head">Tema del Fondo:</p>
                        <div class="d-flex flex-wrap align-items-center switcher-style">
                            <div class="form-check switch-select me-3">
            ...
            <div class="d-flex justify-content-between canvas-footer flex-wrap">
                <a href="javascript:void(0);" id="reset-all" class="btn btn-danger w-100 m-1">Restablecer</a>
            </div>
        </div>
    </div>
</div>
