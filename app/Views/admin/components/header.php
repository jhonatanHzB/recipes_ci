        ...
        <div class="header-content-left">
            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="<?= base_url() ?>" class="header-logo">
                        <img src="<?= base_url() ?>assets/img/brand-logos/chef_ana_paula_logo.png" alt="logo"
                             class="desktop-logo">
                        <img src="<?= base_url(); ?>assets/img/brand-logos/toggle-logo.png" alt="logo"
                             class="toggle-logo">
                        <img src="<?= base_url() ?>assets/img/brand-logos/chef_ana_paula_logo.png" alt="logo"
                             class="desktop-white">
                        <img src="<?= base_url(); ?>assets/img/brand-logos/toggle-white.png" alt="logo"
                             class="toggle-white">
                    </a>
                </div>
            </div>
            ...
            <div class="header-element">
                ...
                <div class="main-header-center d-none d-lg-block">
                    <input class="form-control" placeholder="Buscar recetas..." type="search"> <button class="btn"><i
            ...
            <div class="header-element headerProfile-dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                   data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <img src="<?= base_url() ?>assets/admin/img/faces/6.jpg" alt="img" width="37" height="37" class="rounded-circle">
                </a>
                <!-- End::header-link|dropdown-toggle -->
